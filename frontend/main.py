...
if selected == "Customers":
    ...
    st.write(f'### Number of customers by ages between {age_lb} and {age_ub}')
...
if selected == "Articles":
    ...
    # with col7:
    #     st.write('Top articles table')
    #     st.dataframe(top_articles_filtered)
    # with col8:
    #     st.write('Top colors table')
    #     st.dataframe(top_colors_filtered)
...
if selected == "Transactions":
    ...
    st.write(f'### Daily revenue per day (sum price per day) \n*from {start_date} to {end_date}')
